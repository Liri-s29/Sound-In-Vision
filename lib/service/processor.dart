class Processor {
  static String textToImage(String text) {
    String lowerCaseText = text.toLowerCase();
    // Remove punctuation
    lowerCaseText = lowerCaseText.replaceAll(RegExp(r"[^\w\s\']"), '');
    // Check if text is available in isl_gif array
    if (isl_gif.contains(lowerCaseText)) {
